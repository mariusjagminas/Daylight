...
describe('displayTimezoneData function', () => {
	test('should show the first error message', () => {
		...
		expect(showErrorMessage).toHaveBeenCalledWith('Location not found, please try again.');
	});
	...
	test('should display timezone data', () => {
		...
		expect(nextDateElement.innerText).toBe(
			'Around 10th January 2020 the length of the day will be the same as today'
		);
